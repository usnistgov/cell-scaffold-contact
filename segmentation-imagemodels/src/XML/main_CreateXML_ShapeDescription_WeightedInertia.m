...
%% Create XML file for "ShapeDescription_WeightedInertia.m"

% XML file name
fname = 'test_shapeDescription_WeightedInertia';
fpath = '.'; % path to save the xml file

% Paths
output_filename = './test_data/ContactPointEstimation/Alg2/SpunCoat-07072015_ZProfile/Shape/PhysicalUnit/WeightedInertia.csv';
input_probDirectory = './test_data/ContactPointEstimation/Alg2/SpunCoat-07072015_ZProfile';
input_probPattern = '*.fits';
...
xmldoc = com.mathworks.xml.XMLUtils.createDocument('ShapeDescription_WeightedInertia');
...
root.appendChild(elm);
    ...
    subelm.appendChild(xmldoc.createTextNode(input_probPattern));
    elm.appendChild(subelm);
