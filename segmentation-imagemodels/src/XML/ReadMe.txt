...
main.m: Call all functions and run them. Require XML files (see Section III).
...
|-- test_data
	...
	|-- ContactPointEstimation
		...
		|-- Alg2
			...
			|-- SpunCoat-06252015_ZProfile
				|-- 061115_SC_1_63x_Pos045.fits
				|-- 061115_SC_1_63x_Pos045_Results.mat
				|-- 061115_SC_1_63x_Pos046.fits
				|-- 061115_SC_1_63x_Pos046_Results.mat
				|-- BinaryContact
