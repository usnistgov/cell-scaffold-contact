...
disp('Saving...');
P_total_fits = convert_mat2fits(P_total, 'uint16', 'int16');
fitswrite(P_total_fits, fullfile(output_directory, [parameters_scaffoldType '_P_total.fits']));
param_table = array2table([Ctr.x Ctr.y Ctr.z nD], 'VariableNames',{'CtrX','CtrY','CtrZ','nD'});
writetable(param_table, fullfile(output_directory,[parameters_scaffoldType '_Center_nD.csv']));
disp('Done!');